...
# load proxy data
prox.in <- as.data.frame(read.csv(file = "Phan/PhanData/PhanCompWithTemp_CAO2024.csv"))
...
save(inv.out, file = "inv.out_CAO2024.rda")
save(ages, file = "ages_CAO2024.rda")
save(prox.in, file = "prox.in_CAO2024.rda")
save(flattened, file = "flattened_CAO2024.rda")
save(BWT, file = "BWT_CAO2024.rda")
save(sites, file = "sites_CAO2024.rda")
