...
# load proxy data
prox.in <- as.data.frame(read.csv(file = "Phan/PhanData/PhanCompWithTemp_MERDITH2021.csv"))
...
save(inv.out, file = "inv.out_MERDITH2021.rda")
save(ages, file = "ages_MERDITH2021.rda")
save(prox.in, file = "prox.in_MERDITH2021.rda")
save(flattened, file = "flattened_MERDITH2021.rda")
save(BWT, file = "BWT_MERDITH2021.rda")
save(sites, file = "sites_MERDITH2021.rda")
