...
############################################################################################
system.time({inv.out = jags.parallel(data = data.pass, model.file = "Phan/d13CO2_PSM_pp_NormPrior.R", 
...
save(inv.out, file = "inv.out_NormPrior.rda")
save(ages, file = "ages_NormPrior.rda")
save(prox.in, file = "prox.in_NormPrior.rda")
save(flattened, file = "flattened_NormPrior.rda")
save(BWT, file = "BWT_NormPrior.rda")
save(sites, file = "sites_NormPrior.rda")
