...
#                                      n.iter = 1e4, n.burnin = 1e3, n.thin = 50)})
...
save(inv.out, file = "inv.out_PALEOMAP.rda")
save(ages, file = "ages_PALEOMAP.rda")
save(prox.in, file = "prox.in_PALEOMAP.rda")
save(flattened, file = "flattened_PALEOMAP.rda")
save(BWT, file = "BWT_PALEOMAP.rda")
save(sites, file = "sites_PALEOMAP.rda")
