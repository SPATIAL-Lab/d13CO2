...
# load proxy data
prox.in <- as.data.frame(read.csv(file = "Phan/PhanData/PhanCompWithTemp_TC17.csv"))
...
save(inv.out, file = "inv.out_TC17.rda")
save(ages, file = "ages_TC17.rda")
save(prox.in, file = "prox.in_TC17.rda")
save(flattened, file = "flattened_TC17.rda")
save(BWT, file = "BWT_TC17.rda")
save(sites, file = "sites_TC17.rda")
