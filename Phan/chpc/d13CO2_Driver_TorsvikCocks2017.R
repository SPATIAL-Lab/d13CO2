...
# load proxy data
prox.in <- as.data.frame(read.csv(file = "Phan/PhanData/PhanCompWithTemp_TorsvikCocks2017.csv"))
...
save(inv.out, file = "inv.out_TorsvikCocks2017.rda")
save(ages, file = "ages_TorsvikCocks2017.rda")
save(prox.in, file = "prox.in_TorsvikCocks2017.rda")
save(flattened, file = "flattened_TorsvikCocks2017.rda")
save(BWT, file = "BWT_TorsvikCocks2017.rda")
save(sites, file = "sites_TorsvikCocks2017.rda")
