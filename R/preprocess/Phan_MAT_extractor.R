...
comp <- read.csv("data/paleogeography/phancomp_paleocoord.csv")
paleolon <- comp$plng_CAO2024
paleolat <- comp$plat_CAO2024


# Extract temps from CESM netCDF
ncin <- nc_open("data/raw/High_Resolution_Climate_Simulation_Dataset_540_Myr.nc")
...
GMST_PhanDA <- read.csv("data/raw/PhanDA_GMST.csv")
...
write.csv(comp, "data/processed/PhanCompWithTemp_CAO2024.csv", row.names = FALSE)
