...
#SBATCH --job-name=d13CO2_suite3M
#SBATCH --array=0-6
...
export R_SCRIPT_PATH="${WORK_DIR}/R/model/d13CO2_RunProfile3M_CHPC.R"
...
cd "$WORK_DIR"
echo "Starting ${RUN_PROFILE} at $(date)"
Rscript "$R_SCRIPT_PATH"
echo "Finished ${RUN_PROFILE} at $(date)"
